...
/**
 * <p>Clase Java para consultaTUSResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="consultaTUSResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "consultaTUSResponse", propOrder = {
    "_return"
})
public class ConsultaTUSResponse {
